...
import com.tma.training.restaurant.infra.mysql.BillJpaRepository;
...
import com.tma.training.restaurant.infra.mysql.mapper.impl.BillDataAccessMapper;
import com.tma.training.restaurant.infra.mysql.mapper.impl.OrderItemDataAccessMapper;
...
public class BillRepositoryImpl implements BillRepository {
    ...
    private void updateBillEntity(BillEntity existingEntity, BillModel billModel) {
        ...
        existingEntity.getOrderItems().removeIf(orderItem -> billModel.getOrderItems().stream().noneMatch(updatedItem -> updatedItem.getMenuId().equals(orderItem.getId())));
        ...
        for (OrderItemModel orderItemModel : billModel.getOrderItems()) {
            ...
            if (orderItemEntity != null) { // existing item
                ...
                orderItemEntity.setPrice(orderItemModel.getPrice());
            } else { // new item
